module github.com/mnabbasabadi/grading/service
...
require (
	...
	github.com/mnabbasabadi/grading/api v0.0.0-00010101000000-000000000000
...
replace github.com/mnabbasabadi/grading/api => ../api
